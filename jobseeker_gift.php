...
include_once(PATH_TO_MAIN_PHYSICAL_LANGUAGE.$language.'/'.FILENAME_JOBSEEKER_GIFT);
$template->set_filenames(array('gift' => 'jobseeker_gift.htm'));
include_once(FILENAME_BODY);
$product_id=(int)$_GET['product_id'];
include_once(PATH_TO_MAIN_PHYSICAL_CLASS . 'gift.php');
$gift = new gift();
$obj=$gift->check_status('','jobseeker');
// print_r($obj);print_r($gift->gift_text_array);die();
...
$template->assign_vars(array(
 ...
 'form'=>tep_draw_form('gift', FILENAME_JOBSEEKER_CHECKOUT_PAYMENT, 'product_id='.$product_id, 'post'),
 'button'=>$button,
