...
data[0].applyJob +
'" title="Apply" target="_blank" rel="noopener noreferrer">Bewerben<i class="bi bi-box-arrow-in-up-right ms-2"></i></a>'
}
				</li>
...
<i class="bi bi-linkedin text-linkedin"></i> Linkedin</a>
				...
				<div class="ms-1">
					<h4 class="mb-2" style="font-size:20px;font-weight:bold;">Stellenübersicht</h4>
					<div class="card-text">
						${data[0].job_short_description}	
					</div>
					<h4 class="mb-2 mt-4" style="font-size:20px;font-weight:bold;">Stellenbeschreibung</h4>
					<div class="card-text">
						${data[0].job_description}
					</div>
					<div class="fw-bold mb-2 mt-4">Schlüsselqualifikationen</div>
	`;
card +=
