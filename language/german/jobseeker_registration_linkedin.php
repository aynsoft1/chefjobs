...
define('HEADING_TITLE','Registrierung für Arbeitssuchende');
define('REQUIRED_INFO','* Benötigte Information');
define('SECTION_ACCOUNT_DETAILS','Kontodetails');
define('SECTION_ACCOUNT_PRIVACY','Datenschutzinformationen');
...
define('ENTRY_NATIONALITY_ERROR', 'Bitte wählen Sie die Nationalität.');
define('INFO_TEXT_MARITAL_STATUS', 'Familienstand :');
define('MARITAL_ERROR','Sie müssen Ihren Familienstand auswählen.');
define('INFO_TEXT_COUNTRY','Land :');
define('ENTRY_COUNTRY_ERROR', 'Bitte wählen Sie ein Land.');
...
define('ENTRY_STATE_ERROR', 'Bitte geben Sie den Staat oder die Provinz ein');
...
define('INFO_TEXT_AGREEMENT','<br><b>Hinweis: </b>Wenn Sie auf die folgende <b>Schaltfläche</b> klicken, bedeutet dies, dass Sie unseren <a href="'.FILENAME_TERMS.'" target="terms">Allgemeinen Geschäftsbedingungen</a> und <a href="'.FILENAME_PRIVACY.'" target="terms">Datenschutzrichtlinie</a> zugestimmt haben.');
...
define('INFO_TEXT_SUBSCRIBE','Abonnieren');
