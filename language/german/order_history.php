...
//////////////////////////
define('TABLE_HEADING_PLAN_TYPE_NAME', 'Name des Plantyps');
define('TABLE_HEADING_PRICE', 'Preis');
define('TABLE_HEADING_PLAN_TYPE_TIME_PERIOD', 'Zeitraum');
define('TABLE_HEADING_STATUS', 'Status');
define('TABLE_HEADING_INSERTED', 'Eingefügt');
define('TABLE_HEADING_LAST_UPDATED', 'Letzte Aktualisierung');
define('MESSAGE_SUCCESS_DELETED','Erfolg: Bestellung erfolgreich gelöscht.');
define('MESSAGE_ORDER_ERROR','Leider existiert diese Bestellung nicht. Wenn das Problem weiterhin besteht, wenden Sie sich bitte an den Site-Administrator.');
