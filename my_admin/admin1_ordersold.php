...
else 
{
 ...
 $alternate=1;
  ...
  $template->assign_block_vars('order', array( 'row_selected' => $row_selected,
   'name' => '<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_ORDERS, tep_get_all_get_params(array('oID', 'action','selected_box')) . 'oID=' . $orders['orders_id'] . '&action=edit') . '">' . tep_image(PATH_TO_IMAGE . 'preview.gif', 'Edit') . '</a>&nbsp;' . tep_db_output($orders['recruiter_name']),
