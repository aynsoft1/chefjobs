...
<p class="card-text"><a href="'.tep_href_link(FILENAME_JOBSEEKER_RESUME1).'">'.INFO_POST_RESUME.'</a></p>
...
<p class="card-text"><a href="'.getPermalink(FILENAME_JOBSEEKER_COMPANY_PROFILE).'">'.INFO_TEXT_BY_COMPANY.'</a></p>
...
<p class="card-text"><a href="'.getPermalink(FILENAME_INDUSTRY_RSS).'">'.INFO_TEXT_RSS_ALL_JOBS.'</a></p>

<p class="card-text"><a href="'.getPermalink(FILENAME_JOBSEEKER_LOGIN).'">'.INFO_TEXT_NEWSLETTER.'</a></p>
...
<p class="card-text"><a href="'.getPermalink('quiz/').'">'.INFO_TEXT_QUIZ.'</a></p>
