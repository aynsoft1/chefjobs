...
///---find jobs and cv enjoyed-------//
if($job_cv_check=getAnyTableWhereData(RECRUITER_ACCOUNT_HISTORY_TABLE,"recruiter_id='".$_SESSION['sess_recruiterid']."'","job_enjoyed,recruiter_job,recruiter_cv,cv_enjoyed"))
{	$jobs_alloted=(($job_cv_check['recruiter_job']==2147483647)?'Unlimited':$job_cv_check['recruiter_job']);
	$jobs_enjoyed=$job_cv_check['job_enjoyed'];
	$cv_alloted=(($job_cv_check['recruiter_cv']>=2147483647)?'Unlimited':$job_cv_check['recruiter_cv']);
	$cv_enjoyed=$job_cv_check['cv_enjoyed'];
	$plan_used_details="<br>Jobs Enjoyed (Out of ".$jobs_alloted." ): ".$jobs_enjoyed;
}
///////////////////////////////////////////////
