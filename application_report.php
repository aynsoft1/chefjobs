...
$template->assign_vars(array(
  ...
  'INFO_TEXT_FROM_DATE1'=>year_month_list("name='TR_from_year' class='form-select me-3'",'2007',date("Y"),$year,"name='TR_from_month' class='form-select me-3'",$month,false,true,true),
  ...
  'INFO_TEXT_SUBMIT'=>'<button class="col-md-2 btn btn-primary btn-sm" style="border-radius:5px;" type="submit">Go</button>',//tep_image_submit(PATH_TO_BUTTON.'go.gif', IMAGE_GO),
