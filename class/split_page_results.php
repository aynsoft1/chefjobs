...
class splitPageResults 
{
 ...
 function display_links($query_numrows, $max_rows_per_page, $max_page_links, $current_page_number, $parameters = '', $page_name = 'page', $base_url = null) 
 {
  ...
  if ($num_pages > 1) 
  {
    ...
    if ($base_url == null) {
        ...
        $url_base = tep_href_link($base_url.'/');
    }

   $display_links = "<form name='pages' method='get' action='".$url_base."'>";
   if ($current_page_number > 1) 
   {
    $display_links .= '<a href="' . $url_base."?". $parameters . $page_name . '=' . ($current_page_number - 1) . '" class="splitPageLink">' . PREVNEXT_BUTTON_PREV . '</a>&nbsp;&nbsp;';
   } 
   else 
   {
   ...
   {
    $display_links .= '&nbsp;&nbsp;<a href="' . $url_base."?". $parameters . $page_name . '=' . ($current_page_number + 1) . '" class="splitPageLink">' . PREVNEXT_BUTTON_NEXT . '</a>';
   } 
   else 
   {
