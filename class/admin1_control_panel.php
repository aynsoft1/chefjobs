...
//////////////// Global /////
 $year_listing=year_listing(date('Y'),'2009','name="year" class="form-control form-control-sm form-control form-control-sm-sm" style="border-top-right-radius:0px;border-bottom-right-radius:0px;" ','Year','',$year);
