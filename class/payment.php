...
// class constructor
    function __construct($module = '') {
      ...
      global $payment, $language;//, $_SERVER['PHP_SELF'];
      ...
      if (defined('MODULE_PAYMENT_INSTALLED') && tep_not_null(MODULE_PAYMENT_INSTALLED)) {
        ...
        for ($i=0, $n=sizeof($include_modules); $i<$n; $i++) {
          include(PATH_TO_MAIN_PHYSICAL_LANGUAGE . $language.'/'.PATH_TO_MODULE.'payment/' . $include_modules[$i]['file']);
          include(PATH_TO_MAIN_PHYSICAL_MODULE.'payment/' . $include_modules[$i]['file']);
